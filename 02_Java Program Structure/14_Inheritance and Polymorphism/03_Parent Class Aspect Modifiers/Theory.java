...
Currently, Noodle has an ingredients attribute that its child class Ramen cannot access because it has a private access modifier.
...
Noodle has an isTasty() method that returns true because noodles are tasty.
But if you check in the Ramen class, you’ll see someone overrode isTasty() to return false!
That person clearly doesn’t know food; all noodles are definitely tasty.
