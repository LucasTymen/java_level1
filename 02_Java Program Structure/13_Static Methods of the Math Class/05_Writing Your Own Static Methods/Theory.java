...
Let’s get the syntax out of the way first — just like with variables, to create a static method, use the static keyword in the method’s definition.
...
If you try to mix this with a static method, you’ll see the error message non-static variable this cannot be referenced from a static context.
Instructions
...
After writing the method, call the method at the end of the main() method.
Recall that since this is a static method, you’ll use the name of the class to call the method, not an object of the class.

Your method signature should be public static void averageMoney().
When calling the method, use ATM.averageMoney().
Checkpoint 2 Step instruction is unavailable until previous steps are completed

2.

Let’s try to have averageMoney() interact with a non-static instance variable.
In averageMoney(), try to print this.money.
You should expect to see an error message — a static method can’t interact with a non-static instance variable.
Concept Review
