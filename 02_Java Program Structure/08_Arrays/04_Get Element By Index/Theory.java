...
You can return the 0th index of an array catNames using this syntax:
...
If we had a variable called numCats that we wanted to increment by 1, we could use the syntax:
*/
numCats = numCats + 1;
/*
Concept Review
