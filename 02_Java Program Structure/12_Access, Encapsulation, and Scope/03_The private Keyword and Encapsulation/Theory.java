...
By now you’re probably catching onto what the private keyword does.
...
Let’s look back at our DogSchool example:
...
makeADog is trying to directly access Dog‘s .age variable.
...
Other methods within the Dog class would be able to use .age or .speak() (for example, we could use cujo.age within the Dog class), but other classes won’t have access.
==> https://www.codecademy.com/resources/docs/java/methods
==> https://www.codecademy.com/resources/docs/java/classes

Keep Reading: AP Computer Science A Students

At this point, you might be thinking to yourself “Why even bother with any of this?
In the last exercise, my code was broken until I flipped some variables and methods to public.
...
In the next exercise, we’ll get into when you might want to make methods public — we’ll take a look at getter and setter methods.
Instructions
1.

We’ve changed the variables and methods in CheckingAccount.java back to private.
To begin, go to Bank.java and run your code.
Let’s confirm that we get errors when a Bank tries to access private data from a CheckingAccount
2.

A Bank couldn’t access a CheckingAccount‘s private structures.
Let’s prove to ourselves that CheckingAccount can access its own private fields.

Go to CheckingAccount.java. In the main() method, create a new CheckingAccount named myAccount.
You’ll have to use the constructor that takes a String and an int.
...
Let’s confirm that we can access a CheckingAccount‘s private fields since we’re writing in CheckingAccount‘s main() method.
Still in CheckingAccount.java, print out myAccount‘s balance.

You’ll want to print myAccount.balance
4.

Let’s also confirm that we can use private methods. Call addFunds() to add 5 dollars to myAccount‘s balance.
Then print the balance again to confirm the money was added.
Continue to do this work in the main() method of CheckingAccount.java.
