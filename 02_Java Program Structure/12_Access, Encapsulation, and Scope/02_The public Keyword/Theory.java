...
After running the code in the last exercise, you should be developing an intuition on what the public and private keywords are doing.
...
Any method of the DogSchool class could make a new Dog using the public Dog constructor, directly access that Dog’s instance variables, and directly use that Dog’s methods:
*/
...
We have public methods calling public methods!
...
Once again we’ve given you a Bank class and a CheckingAccount class.
First, take a look at CheckingAccount.java to see what methods and variables have been set to private or public.
Then, switch to Bank.java, look at the main method, and hit the “Run” button.
You should get an error.
Why?

The main method is trying to access three different fields from CheckingAccount that are all private.
Those would need to be public in order for Bank‘s main() method to run.
2.

In Bank.java‘s main() method, we’re trying to access three different private fields from the CheckingAccount class.
Edit the checking account class to make those fields public.
Make sure to edit only the fields you need in order to make Bank‘s main() method run — don’t change any of the other fields in CheckingAccount.
...
It’s also trying to use CheckingAccount‘s private .addFunds() method.
Finally, Bank‘s main() method is trying to call its own .getInfo() method.
This method tries to print the private .address instance variable of all of its CheckingAccounts.
Concept Review
