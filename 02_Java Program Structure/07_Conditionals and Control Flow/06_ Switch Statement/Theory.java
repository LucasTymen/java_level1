...
==> https://www.codecademy.com/resources/docs/java/switch?page_ref=catalog
...
/*
This example enrolls the student in History class by checking the value contained in the parentheses, course, against each of the case labels.
...
There’s an uninitialized variable shippingCost in calculateShipping().
Assign the correct value to shippingCost using a switch statement:
