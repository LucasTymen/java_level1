...
Here’s an example demonstrating the order:
...
// The shipping instance field is a String so we’ll need to use equals() for our condition.
Here’s how we’d write a simple if-then:
