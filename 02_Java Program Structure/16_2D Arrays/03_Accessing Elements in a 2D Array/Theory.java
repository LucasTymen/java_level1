...
We provide the index of the element we want to access inside a set of brackets. Let’s see those examples in code:
...
This is because instead of only providing a single index, we provide two indices. Take a look at this example:
...
Using this knowledge, we now know that the result of int stored = data[0][2]; would store the integer 6.
...
Remember, we can access the 2D array element using this format:
arrayName[row][column]. retrievedInt should be an int variable.

Remember, arrays are indexed from 0, so the first row is index 0 and the fourth column is index 3.

Checkpoint 2 Step instruction is unavailable until previous steps are completed

2.

Print the center value of intMatrix multiplied by 3 to the console.
