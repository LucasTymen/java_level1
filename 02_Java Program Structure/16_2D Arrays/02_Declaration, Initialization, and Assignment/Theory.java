...
Use the data type, two sets of brackets, and the name of the variable.
...
Create a 2D char array called ticTacToe representing this tic-tac-toe board. Use the characters 'X', 'O', and ' '.
...
When no one is looking, you want to modify the game so 'O' wins.
Replace the game board so that all X’s are O’s and all O’s are X’s.
Do this in one line with initializer lists. Do not declare ticTacToe again.
