...
==< https://www.codecademy.com/resources/docs/java/strings/equals?page_ref=catalog
...
==> https://www.codecademy.com/resources/docs/java/strings/equalsIgnoreCase?page_ref=catalog
...
In the example above, "Mango" comes before "Peach", so we get a negative number (we specifically get -3 because the Unicode values of "M" and "P" differ by 3).
If we did flavor2.compareTo(flavor1), we would get 3, signifying that "Peach" is greater than "Mango".
...
For example, when comparing "Mango" and "Peach", we got -3, meaning that "Mango" was smaller.
But if we compare "mango" and "Peach" we get 29.
The Unicode value for lower case "m" is actually larger than upper case "P". Using .compareToIgnoreCase() will perform the same task, but will not consider upper/lower case.
==> https://www.codecademy.com/resources/docs/java/strings/compareToIgnoreCase?page_ref=catalog
